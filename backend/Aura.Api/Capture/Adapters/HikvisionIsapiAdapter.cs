...
public sealed class HikvisionIsapiAdapter : ICaptureAdapter
{
    ...
    public CapturePayload Normalize(JsonElement rawPayload)
    {
        ...
        var captureTimeText = TryGetString(rawPayload, "captureTime");
        var captureTime = DateTimeOffset.TryParse(captureTimeText, out var dt) ? dt : DateTimeOffset.Now;
