...
public sealed class OnvifAdapter : ICaptureAdapter
{
    ...
    public CapturePayload Normalize(JsonElement rawPayload)
    {
        ...
        var eventTimeText = TryGetString(rawPayload, "eventTime");
        var captureTime = DateTimeOffset.TryParse(eventTimeText, out var dt) ? dt : DateTimeOffset.Now;
