...
const PERMISSION_CN_MAP = Object.freeze({
  ...
  ai_platform: "AI 平台管理",
  "ai.platform": "AI 平台管理",
  media_analysis_view: "媒体解析查看",
  "media.analysis.view": "媒体解析查看",
  media_analysis_manage: "媒体解析配置",
  "media.analysis.manage": "媒体解析配置",
  media_analysis_operate: "媒体解析操作",
  "media.analysis.operate": "媒体解析操作",
  media_analysis_replay: "媒体事件重放",
  "media.analysis.replay": "媒体事件重放",
  vector_index_manage: "向量索引管理",
  "vector.index.manage": "向量索引管理",
  graph_view: "关系图查询",
  "graph.view": "关系图查询",
  graph_admin: "关系图运维",
  "graph.admin": "关系图运维",
